...
const Biosection = () => {
  return (
    <div className="section block md:flex flex-wrap">
      <div
        data-aos="fade-up"
        data-aos-delay="100"
        className="circular_profile flex flex-col justify-center sm:justify-center px-16 items-center h-auto w-full md:w-2/5 mx-auto"
      >
        <div className="circular_avatar sm:mt-32 text-center relative w-full sm:w-[350px] sm:h-[350px] border-[5px] border-orange-500 rounded-full md:w-[350px] md:h-[350px] flex flex-col">
          <img
            className="bg-cover object-cover rounded-full w-full h-full max-w-full"
      ...
      >
        ...
        <div className="info mt-5 flex flex-col md:flex-row justify-end w-full">
          ...
          <div className="right mt-2 md:mt-0 w-full md:w-2/4 md:ml-16">
            ...
            <p className="mt-2">
              <span className="font-semibold">Address:</span>{" "}
              <span className="ml-1 text-gray-400">Kathmandu Kathmandu</span>{" "}
            </p>
          </div>
        </div>
      </div>
