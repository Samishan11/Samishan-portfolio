...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } w-[80px] border-r-[.5px] text-center fixed top-0 left-0 h-screen`}
    >
          ...
          <a href={"#biography"}>
            <i
              className={`fa-solid fa-user ${
                window.document.getElementById("biography") === targetElevemt &&
                "text-orange-500"
              }`}
            ></i>
          </a>
